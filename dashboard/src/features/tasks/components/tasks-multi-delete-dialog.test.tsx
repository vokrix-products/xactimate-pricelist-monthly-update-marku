...
describe('TasksMultiDeleteDialog', () => {
  ...
  it('deletes selected rows and resets selection when deleted successfully', async () => {
    ...
    expect(mutateAsync).toHaveBeenCalledWith(['row-0', 'row-1'])
